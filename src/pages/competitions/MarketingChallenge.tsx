...
const MarketingChallenge = () => {
  ...
  const judges = [
    ...
    {
      name: "David Kim",
      title: "Creative Director, Leading Ad Agency",
      image: "/placeholder.svg",
    },
    {
      name: "Lisa Thompson",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="text-center space-y-4">
                ...
                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary via-[hsl(195,70%,40%)] to-accent bg-clip-text text-transparent pb-1">Marketing Role Play</h1>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Step into the role of expert marketing consultants solving critical, real-world business dilemmas
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-12">
            ...
            <Card className="p-4 md:p-8 bg-card border-accent/20 shadow-md">
              ...
              <p className="text-xs md:text-base text-muted-foreground leading-relaxed mb-3 md:mb-6">
                The Marketing Role Play invites you to step into the role of expert marketing consultants who must rapidly solve a critical, real-world business dilemma. Participants are tasked with analyzing complex situations, such as expanding into new markets or combating aggressive competition, and applying their knowledge of core marketing fundamentals to develop a viable and comprehensive strategy.
              </p>
              <p className="text-xs md:text-base text-muted-foreground leading-relaxed">
                You will articulate and present your innovative solutions to a business executive (the judge), demonstrating professional judgment, organized ideas, and outstanding communication skills while defending your strategic recommendations in a high-pressure environment. This event tests your ability to connect company actions with results and develop effective strategies for complex market challenges.
              </p>
            </Card>
            ...
            <Card className="p-4 md:p-8 bg-card border-accent/20 shadow-md">
              ...
              <p className="text-xs md:text-base text-muted-foreground mb-4">
                Participants should be prepared to demonstrate understanding across these core marketing concepts:
              </p>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground">
                    Technical evaluation criteria reflecting how well participants apply the core marketing concepts outlined in the knowledge areas. The judge evaluates 5 specific Performance Indicators relevant to the scenario, each worth a maximum of 10 points.
                  </p>
                </div>
                <div>
              ...
              <div className="flex flex-col gap-3 md:gap-4">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs md:text-sm text-muted-foreground">Download the full Marketing Role Play guide with study materials and detailed knowledge area objectives</p>
                  </div>
                </div>
            ...
            <Card className="p-4 md:p-8 bg-card border-accent/20 shadow-md">
              ...
              <ul className="space-y-2 md:space-y-3 text-xs md:text-base text-muted-foreground">
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-accent mt-2 flex-shrink-0" />
                  <span><strong>Prepare Broadly:</strong> Study all 10 knowledge areas as the scenario may draw from any of them.</span>
                </li>
              </ul>
            </Card>
...
export default MarketingChallenge;