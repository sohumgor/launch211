              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground">
                    Technical evaluation criteria reflecting how well participants apply the core marketing concepts outlined in the knowledge areas. The judges evaluate 5 specific Performance Indicators relevant to the scenario, each worth a maximum of 10 points.
                  </p>
                </div>
                <div>
