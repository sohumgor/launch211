    ...
    <main>
      ...
      <section className="section workshop-overview">
        <div className="site-container">
          <div className="section-heading-row"><div><p className="eyebrow">Workshop tracks</p><h2>Three lenses on real business work.</h2></div><div><p>Students will select a track during registration based on their interests. Session leaders and room assignments will be announced before conference day.</p><span className="planning-badge">Leaders announced soon</span></div></div>
      ...
      <section className="section workshop-format-section">
        <div className="site-container workshop-format-grid">
          <div><p className="eyebrow eyebrow-light">Inside each session</p><h2>Built for participation.</h2><p>Each workshop combines professional context with an activity, small-group discussion, and time for student questions.</p></div>
      ...
      <section className="section">
        <div className="site-container workshop-bottom-grid"><div><Users aria-hidden="true" /><p className="eyebrow">For students</p><h2>Choose during registration.</h2><p>Students will choose a track during conference registration. Capacity, session topics, and room assignments will be shared with confirmed participants.</p><Link to="/registration" className="text-link">Get registration updates <ArrowRight aria-hidden="true" /></Link></div><div><MessageSquare aria-hidden="true" /><p className="eyebrow">For professionals</p><h2>Lead a useful room.</h2><p>LaunchPoint is recruiting professionals who can teach through a practical exercise and an honest conversation about their field.</p><Link to="/get-involved#inquiry" className="text-link">Propose a workshop <ArrowRight aria-hidden="true" /></Link></div></div>
      </section>
    </main>
    <Footer />
  </div>
