...
**Project:** LaunchPoint
**Generated:** 2026-07-31 16:23:21
**Category:** Hyperlocal Services
**Design Dials:** Variance 6/10 (Editorial / Branded) | Motion 2/10 (Restrained) | Density 3/10 (Spacious)
...
|------|-----|--------------|
| Primary | `#0A2244` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#1EB8B8` | `--color-secondary` |
| Accent/CTA | `#F4B82D` | `--color-accent` |
| Background | `#F6F7F2` | `--color-background` |
| Foreground | `#111A24` | `--color-foreground` |
| Muted | `#E8ECF0` | `--color-muted` |
| Border | `#E4E4E7` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#18181B` | `--color-ring` |

**Color Notes:** Official LaunchPoint navy and teal, with gold reserved for primary actions and award details.
...
- **Mood:** editorial, ambitious, credible, student-led, community-backed
...
**Style:** Editorial event identity

**Keywords:** Bold type, clean grid, ticket motif, geometric detail, high contrast, restrained motion
